...
const articleMaker = input => {
  ...
  p1.textContent = input.firstParagraph;
  p2.textContent = input.secondParagraph;
  p3.textContent = input.thirdParagraph;
...
data.forEach(ele => {
  ...
  articles.appendChild(articleMaker(ele));
});
